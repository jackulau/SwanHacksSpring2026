...
migrate((app) => {
  const pages = new Collection({
    ...
    "fields": [
      ...
      { "cascadeDelete": false, "collectionId": "pbc_note_pages", "hidden": false, "id": "f_np_parent", "maxSelect": 1, "minSelect": 0, "name": "parent", "presentable": false, "required": false, "system": false, "type": "relation" },
